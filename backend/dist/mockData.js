...
exports.mockEdges = exports.mockNodes = void 0;
exports.seedWarehouseMap = seedWarehouseMap;
...
function seedWarehouseMap() {
    const map = new graph_1.WarehouseMap();
    for (const node of exports.mockNodes) {
        map.addNode(node);
    }
    for (const edge of exports.mockEdges) {
